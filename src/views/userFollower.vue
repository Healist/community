<template>
  ...
  <div class="container">
    <div class="account" v-show="isUserExist">
      ...
      <zd-crumbs></zd-crumbs>
      <h3>关注&nbsp; {{accountName}}的人</h3>
      <ul class="users-container" v-show="followers != ''">
        <li class="users-box registered-user" v-for="item in followers">
          <a>
      ...
      <div class="alert alert-warning text-center" v-show="followers == ''">此用户还没有粉丝 :(</div>
    </div>
