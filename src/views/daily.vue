<template>
  ...
  <div class="container">
    ...
    <ul class="collection" v-show="items != ''">
    ...
    <div class="alert alert-warning text-center" v-show="items == ''">暂无热门主题 :(</div>
...
<script>
  export default{
    ...
    created: function () {
      this.$http.get(
        'http://123.207.167.206:3000/users/daily',
        {},
        {
          'headers': {
    ...
    components:{
      ...
      "zdSearchtag": require('../components/searchtag.vue'),
